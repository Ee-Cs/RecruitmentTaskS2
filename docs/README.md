...
- End-to-end (integration) tests using Cypress.\
  The [screenshots](https://github.com/ee-cs/RecruitmentTaskS2/tree/main/cypress/screenshots)
  generated by Cypress.
- [Live demo](https://ee-cs.github.io/RecruitmentTaskS2/) with multiple data sets.
