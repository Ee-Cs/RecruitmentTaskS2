...
Used is Angular Material.
Used is an in-memory store.


## Menu actions descripton
- Home
...
### Proposed validation logic to implement
...
Live Angular application demo  ➔   
  [Recruitment Task S2 (GitHub Pages)](https://k1729p.github.io/Study27/home)
